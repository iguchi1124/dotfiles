...
open questions, skipped work, and residual risks are explicit. Report the outcome and
the absolute coordination-directory path so the paper trail is discoverable.
